...
# Jumlah cek yang di-skip (counter; maksimal 4: timeout + prove-ok +
# prove-bad + checked; dua prove skip bersamaan bila Frama-C/WSL hilang);
# dipakai pesan akhir agar konsisten dgn jumlah [OK] yang benar2 dijalankan.
SKIPPED_COUNT = 0
