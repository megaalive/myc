...
| `testaudit.c` | Test-Quality Audit (Fase 6): cakupan corpus test per hazard class + backend; `myc audit-tests`; gap eksplisit, NON-blocking |\| run [backend]`; canary gagal = backend UNRELIABLE |
